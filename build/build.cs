...
namespace build
{
    internal class Build
    {
        ...
        private const string GITHUB_REPO = "https://github.com/jasperfx/baseline.git";
        ...
        private static void Main(string[] args)
        {
            ...
            Target("restore", () =>
            {
                Run("dotnet", "restore src/Baseline.sln");
            });
           
            Target("test", DependsOn("restore"),() =>
            {
                RunTests("Baseline.Testing");
                RunTests("BaselineTypeDiscovery.Testing");
            });
