...
task :version do
  ...
  options = {
	...
	:copyright => 'Copyright 2009-15 Jeremy D. Miller, Chad Myers, Joshua Arnold, Joshua Flanagan et al. All rights reserved.',
	:trademark => commit,
	:version => asm_version,
...
task :compile => [:clean] do
	...
	sh "#{msbuild} src/Baseline.sln   /property:Configuration=#{COMPILE_TARGET} /v:m /t:rebuild /nr:False /maxcpucount:2"
end
